                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                  <select name="kategori" class="select2" data-placeholder="Choose a Country...">
													  ...
													  <option value="PJ">Pengiriman Jakarta</option>
													  <option value="PY">Pengiriman Yogyakarta</option>
                                                      <option value="BPT">Buku Perguruan Tinggi</option>
                                                      <option value="BPO">Buku Perguruan Pre-Order</option>
                                                      <option value="BP">Buku Paketan</option>
												  </select>
                                                </div>
                                            </div>
											<div class="form-group">
