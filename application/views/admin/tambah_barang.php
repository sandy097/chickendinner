                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                  <select name="kategori" class="select2" data-placeholder="Choose a Country...">
													  <option value="#">&nbsp;</option>
													  <option value="Camera">Pengiriman Jakarta</option>
													  <option value="Handphone">Pengiriman Yogyakarta</option>
													  <option value="Notebook">Buku Perguruan Tinggi</option>
													  <option value="Netbook">Buku Pre-Order</option>
													  <option value="PC">Buku Paketan</option>
												  </select>
                                                </div>
                                            </div>
											<div class="form-group">
