...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    <a class="brand" href="<?php echo base_url();?>"><img src="<?php echo base_url('assets/bootshop/themes/images/choco.jpg');?>" alt="Choco Books" width="200px" height="500px"/></a>
		<form class="form-inline navbar-search" method="post" action="<?php echo site_url('welcome/cariproduk');?>" >
		<input id="srchFld" class="srchTxt" name="keyword" type="text" />
