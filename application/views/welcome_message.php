...
<div id="welcomeLine" class="row">
	<div class="span6">Welcome!<strong> Reader^^</strong></div>
	<div class="span6">
				  ...
				  <p style="min-height:160px;">
					...
					<div class="caption">
					  ...
					  <h4 style="text-align:center">
					  	<a class="btn" href="<?php echo site_url('welcome/detailproduk/'.$produk->product_id);?>"> <i class="icon-zoom-in"></i></a> 
					  	<a class="btn" href="<?php echo site_url('welcome/add_to_cart/'.$produk->product_id);?>">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">Rp. <?php echo number_format($produk->price,0,',','.');?></a></h4>
					</div>
				  </div>
				</li>
				<?php endforeach;?>
...
<!-- Footer ================================================================== -->
	...
	<div class="container">
		<div class="row">
			<div id="ket" class="span3 pull-left">
				<p class="footer">
				&copy; Choco Books <?php echo date('Y') ?><br>
